document.addEventListener("DOMContentLoaded", function() {
    ...
    const PRODUCT_QUANTITIES = {
            ...
            "PACK 12 zero Lata 33": [9, 18],
            "Minicam zero PACK 6X20 CL.": [9, 18],
            "Coca-Cola Light pack 4 2L": [9, 18],
            "Coca-Cola Light Bipack 2L": [9, 18],
            ...
            "PACK 9 Light Lata 33": [9, 18],
            "SEMI PACK 12 CC Zero Zero (90x2)=180": [2, 4],
            "Coca-Cola Zero Zero pack 6 2L": [2, 4],
            "SEMI PACK 4 Coca Zero Zero Regular 2 L.": [9, 18],
            "Coca-Cola Zero Zero pack 4 2L": [9, 18],
            "SEMI BIPACK CC Zero Zero Pet 2x2L": [9, 18],
            "Coca-Cola Zero Zero Bipack 2L": [9, 18],
            "Coca-Cola Zero Zero 2L": [9, 18],
            ...
            "BIPACK Fanta Naranja Pet 2 L.": [9, 18],
            "SEMI Fanta Pet.2 L Naranja (150x2)=300": [2, 4],
            "Fanta Naranja Pet 2 L.": [9, 18],
            "Fanta Naranja Pet 1,25L": [19, 38],
            "Fanta Naranja Pet 500": [9, 18],
            "SEMI  PACK 9 lata Fanta Naranja (120x2)=240": [2, 4],
            "Pack x 9 Fanta Naranja Lata 33 cl.": [9, 18],
            "SEMI  Fanta Naranja lata (960x2)=1920": [2, 4],
            "Fanta Naranja Lata 33 cl.": [9, 18],
            "MINI LATA Fanta Naranja pack 6X20 CL": [9, 18],
            "BIPACK Fanta Zero Nar 2 L.": [9, 18],
            "Fanta Zero Nar 2 L.": [9, 18],
            "Pack x 6 Fanta Zero Naranja Lata 33": [9, 18],
            "Fanta Zero Naranja Lata 33": [9, 18],
            "SEMI BIPACK Fanta Limón 2X2L": [2, 4],
            "BIPACK Fanta limón Pet 2 L.": [9, 18],
            "SEMI Fanta Pet.2 L Limón (150x2)=300": [2, 4],
            "Fanta limón Pet 2 L.": [9, 18],
            "Fanta limón Pet 1,25L": [19, 38],
            "Fanta limón Pet 500": [9, 18],
            "SEMI  PACK 9 lata Fanta Limón (120x2)=240": [2, 4],
            "Pack x 9 Fanta limón Lata 33 cl.": [9, 18],
            "SEMI  Fanta Limón lata (960x2)=1920": [2, 4],
            "Fanta limón Lata 33 cl.": [9, 18],
            "BIPACK Fanta Zero lim 2 L.": [9, 18],
            "Fanta Zero lim 2 L.": [9, 18],
            "Fanta Zero limón Lata 33": [9, 18],
            "Fanta Sandía sin azúcar Pet 1.25L C6": [9, 18],
            "Fanta Frambuesa sin azúcar Pet 1.25L C6": [9, 18],
            "Fanta Sandía LATA 33": [9, 18],
            "Fanta Frambuesa LATA 33": [9, 18],
            "Sprite Lata Pack 6X20 CL.": [9, 18],
            "Sprite Pet 2 L.": [9, 18],
            "BIPACK Sprite Pet 2 L.": [9, 18],
            "Sprite Zero Pet 2 L": [9, 18],
            "Sprite lata 33": [9, 18],
            "Sprite Zero lata 33": [9, 18],
            "Sprite lata 33 P9": [9, 18],
            "Sprite Pet 500": [9, 18],
            "Nordic Mist lata 250": [9, 18],
            "Nordic Blue Lata 25 cl.": [9, 18],
            "Royal Bliss Bitter Roso Cesta VNR20 P4 C6": [9, 18],
            "Nordic Zero Lata 25 cl.": [9, 18],
            "Nordic Mist Tónica 1L": [9, 18],
            "Limca PET1L C12": [9, 18],
            "Royal Bliss Berry Lata 25 C12": [9, 18],
            "Royal Bliss Signature WTR Lata 25 C12": [9, 18],
            "Royal Bliss Signature tónica Zero Lata 25 C12": [9, 18],
            "Royal Bliss Lemon Mixer Lata 25 C12": [9, 18],
            "Royal Bliss Berry CESTA VNR20 P4 C6": [9, 18],
            "Royal Bliss Yuzu CESTA VNR20 P4 C6": [9, 18],
            ...
            "Limón&Nada Clásica 1 L.": [9, 18],
            "Fuze Limón Lata 33": [9, 18],
            "Fuze Limón sin azúcar Lata 33": [9, 18],
            "Fuze Limón Pet 50": [9, 18],
            "Fuze Limón Pet 1,5L": [9, 18],
            "Fuze Limón sin azúcar Pet 1,5L": [9, 18],
            "Fuze Tea Peach Hibiscus PET1.5L": [9, 18],
            ...
            "Reign Melon manía Lata 50 C12": [9, 18],
            "Reign Razzle Berry Lata 50 C12": [9, 18],
            ...
            "Pack x 9 Aquarius Limón Lata 33 cl.": [9, 18],
            "Pack x 9 Aquarius Naranja Lata 33 cl.": [9, 18],
            "Aquarius limón Pet 500": [9, 18],
            "Aquarius Naranja Pet 500": [9, 18],
            "SEMI  Aquarius Limón Pet 1´5 l. (195x2)= 390": [2, 4],
            "Aquarius limón Pet 1,5 L.": [9, 18],
            "SEMI Aquarius naranja Pet 1,5 L.(195x2)=390": [2, 4],
            "Aquarius Naranja Pet 1,5 L.": [9, 18],
            "Aquarius Limón Sin Azúcar Pet 1,5 L.": [9, 18],
            "Aquarius Naranja Sin Azúcar Pet 1,5 L.": [9, 18],
            "Aquarius Melocotón Rojo Pet 1.5L C6": [9, 18],
            "Pack x 4 Aquarius Limón Pet 1,5 L.": [9, 18],
            "Pack x 4 Aquarius Naranja Pet 1,5 L.": [9, 18],
            "BIPACK Aquarius Limón Pet 1,5 L.": [9, 18],
            "BIPACK Aquarius Naranja Pet 1,5 L.": [9, 18],
